  ...
  <div class="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900">
    ...
    <div class="max-w-5xl mx-auto p-6">
      ...
      <div class="text-center mb-12 pt-8">
        <div class="w-24 h-24 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl border-4 border-emerald-200">
          <span class="text-white font-bold text-3xl">璟</span>
        </div>
        <h1 class="text-4xl font-bold text-emerald-50 mb-4">歡迎來到璟的個人空間</h1>
      ...
      <div class="grid lg:grid-cols-2 gap-8">
        ...
        <fieldset class="relative border-2 border-pink-300 rounded-2xl bg-white/95 backdrop-blur-sm shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1">
          ...
          <div class="p-8 pb-16 relative min-h-[400px]">
            <div v-if="latestQianArticle">
              <!-- 文章內容 -->
              <div class="mb-6">
                <h3 class="text-2xl font-bold text-gray-800 mb-4 border-b-2 border-pink-200 pb-2">
                ...
                <div class="flex items-center text-sm text-pink-600 mb-4">
...
const removeFavorite = async (articleId) => {
  try {
    if (process.client) {
      ...
      await deleteDoc(doc(db, 'jing_favorites', articleId))
