  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50">
    ...
    <div class="max-w-6xl mx-auto p-6">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-2">璟的觀賞空間</h1>
        ...
        <div class="flex flex-wrap items-center gap-4 justify-between">
          ...
          <div class="flex flex-wrap gap-2">
            <button 
              ...
              :class="{'bg-emerald-600 text-white': currentAuthor === 'jing', 'bg-gray-100 text-gray-700 hover:bg-gray-200': currentAuthor !== 'jing'}"
            ...
            <button 
              ...
              :class="{'bg-emerald-600 text-white': currentAuthor === 'qian', 'bg-gray-100 text-gray-700 hover:bg-gray-200': currentAuthor !== 'qian'}"
              class="px-3 py-1 rounded-full text-sm transition-colors"
            >
              芊的文章
            </button>
            <button 
              @click="currentAuthor = ''"
              :class="{'bg-emerald-600 text-white': currentAuthor === '', 'bg-gray-100 text-gray-700 hover:bg-gray-200': currentAuthor !== ''}"
              class="px-3 py-1 rounded-full text-sm transition-colors"
            >
              全部文章
            </button>
      ...
      <div class="mb-6 p-4 bg-white rounded-xl shadow-md">
        <div class="flex flex-wrap items-center gap-4 justify-between">
          ...
          <div class="flex flex-wrap gap-2">
            <button 
              @click="currentTag = ''"
              :class="{'bg-emerald-600 text-white': currentTag === '', 'bg-gray-100 text-gray-700 hover:bg-gray-200': currentTag !== ''}"
              class="px-3 py-1 rounded-full text-sm transition-colors"
            >
              全部
            </button>
            <button 
              ...
              :class="{'bg-emerald-600 text-white': currentTag === tag, 'bg-gray-100 text-gray-700 hover:bg-gray-200': currentTag !== tag}"
              class="px-3 py-1 rounded-full text-sm transition-colors"
            >
              {{ tag }}
            </button>
      ...
      <div v-else class="text-center py-16">
        <div class="inline-block p-6 rounded-full bg-emerald-100 mb-4">
        ...
        <button 
          ...
          class="mt-6 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg text-lg font-medium transition-colors inline-flex items-center"
        >
...
const currentAuthor = ref('jing'); // 預設顯示璟的文章
...
// 清理
onBeforeUnmount(() => {
  document.body.style.overflow = ''; // 恢復滾动
});
</script>
