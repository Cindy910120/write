        ...
        <div class="bg-emerald-600 px-6 py-3 flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            ...
            <button
              ...
              class="flex items-center space-x-1 bg-teal-500 hover:bg-teal-400 text-white px-3 py-1 rounded-lg text-sm transition-colors disabled:opacity-50"
            >
...
const saveDraft = async () => {
  ...
  try {
    if (process.client) {
      ...
      await addDoc(collection(db, 'jing_articles'), articleData)
